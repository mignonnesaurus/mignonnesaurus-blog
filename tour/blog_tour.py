...
class BlogTour(BaseCase):
    def test_blog(self):
        ...
        self.save_screenshot('login_page.png', folder='tour/screenshots')
        self.click('input[type="submit"]')
        self.save_screenshot('admin_page.png', folder='tour/screenshots')

        self.click('link=VIEW SITE')

        self.click('.glyphicon-plus')
        self.save_screenshot('add_new_post.png', folder='tour/screenshots')
        ...
        self.click('.publish')
        self.open(home_page)
        self.save_screenshot('posts_list.png', folder='tour/screenshots')

        self.click('link=Star Wars IX: The Rise of Skywalker')
        self.click('.add-comment')
        self.save_screenshot('add_comment.png', folder='tour/screenshots')
        ...
        self.save_screenshot('posts_list_with_comments.png', folder='tour/screenshots')
